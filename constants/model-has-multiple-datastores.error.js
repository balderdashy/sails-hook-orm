module.exports = {
  ...
  'Please set its configured datastore to a string instead of an array in its model definition (`.datastore`) or the app-wide default (`sails.config.models.connection`)\n'+
