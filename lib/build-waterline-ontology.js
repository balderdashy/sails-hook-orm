    ...
    ORM.initialize({
      ...
      datastores: (function (){
        var normalizedDatastoreConfigs = _.reduce(hook.datastores, function _eachDatastore(memo, datastore, datastoreIdentity) {
          memo[datastoreIdentity] = datastore.internalConfig;
          return memo;
        }, {});
        // console.log('BUILDING ONTOLOGY USING DATASTORES:',normalizedDatastoreConfigs);
        // e.g.
        // BUILDING ONTOLOGY USING DATASTORES:
