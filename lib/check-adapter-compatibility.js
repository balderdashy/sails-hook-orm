 ...
 * @param  {Ref} adapter
 * @param  {Array} mandatoryDriverMethods
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 ...
 */
module.exports = function checkAdapterCompatibility(datastoreIdentity, adapter, mandatoryDriverMethods) {
  ...
  if (!_.isArray(mandatoryDriverMethods)) {
    throw new Error('Consistency violation: A valid `mandatoryDriverMethods` must be provided as the 3rd argument.');
  }
  ...
  // TODO: check mandatory driver methods
