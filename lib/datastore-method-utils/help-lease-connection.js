...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// TODO: have this take `manager` instead of `datastoreName`
// to make this method more flexible in regards to dynamical
// datastore config that isn't specified until lease-time.
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
        ...
        driver.releaseConnection({ connection: db, meta: options.meta }, {
          error: function(secondaryErr) {
            ...
            return done(new Error(
              'The provided `during` function encountered an error:\n'+
              '``` (1)\n'+
              duringErr.stack +'\n'+
              '```\n'+
