...
// module.exports = function sendNativeQuery(nativeQuery, explicitCbMaybe, metadataMaybe, dbConnectionMaybe){

//   return parley(function _handleExec(done){

//     console.log('nativeQuery:',nativeQuery);
//     console.log('metadataMaybe:',metadataMaybe);
//     return done();

//   }, explicitCbMaybe, {
//
//     // FUTURE: pull these out into utilities like getMetaMethod and getUsingConnectionMethod
//     // (the latter is for .sendStatement() and .sendNativeQuery() only)
//
//     meta: function(_meta){
//       // If metadataMaybe already exists, shallow-merge on top of it.
//       // (this is important for when .usingConnection is combined with .meta)
//       if (metadataMaybe) {
//         _.extend(metadataMaybe, _meta);
//       }
//       else {
//         metadataMaybe = _meta;
//       }
...
//     },
//
//     usingConnection: function(_db){
//       metadataMaybe = metadataMaybe || {};
//       metadataMaybe.leasedConnection = _db;
//       return this;
//     },
//
//   });//</parley()>
