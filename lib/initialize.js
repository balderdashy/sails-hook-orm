...
module.exports = function initialize(hook, sails, done){
  sails.log.debug('--------------------------------------------------------------------------------');
  sails.log.debug('This app is loading a custom or not-yet-released version of the `orm` hook.');
  sails.log.debug('See https://github.com/mikermcneil/sails-hook-orm for more information.');
  sails.log.debug('--------------------------------------------------------------------------------');
  sails.log.debug();
  ...
  async.auto({
    ...
    _determineRelevantDatastoreIdentities: ['_loadModelsAndCustomAdapters', function (next){
