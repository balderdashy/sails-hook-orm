...
module.exports = function validateAdapter (originalAdapter, adapterIdentity, datastoreIdentity) {
  ...
  if (!util.isObject(originalAdapter)) {
  ...
  if (originalAdapter.defaults) {
    if (util.isFunction(originalAdapter.defaults) || util.isArray(originalAdapter.defaults) || !util.isObject(originalAdapter.defaults)) {
