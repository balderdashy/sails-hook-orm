...
module.exports = function validateModelDef (originalModelDef, modelIdentity, hook, sails) {
  ...
  var normalizedDatastoreConfig = validateDatastoreConfig(normalizedModelDef.connection[0], modelIdentity, hook, sails);
  ...
  if (util.isUndefined(normalizedModelDef.schema)) {
    if (!util.isUndefined(normalizedDatastoreConfig.schema)) {
