...
//
  ...
  normalizedModelDef.native = function (done){
    ...
    if (!isUsingSailsMongo) {
      return done(new Error('This model (`'+normalizedModelDef.identity+'`) does not appear to be using the `sails-mongo` adapter, so `.native()` cannot be used.  (See http://sailsjs.com/docs/reference/waterline-orm/models/native)'));
    }
