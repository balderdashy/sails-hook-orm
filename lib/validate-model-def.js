...
//
   ...
   * >  • http://sailsjs.com/documentation/reference/waterline-orm/models/native
  ...
  normalizedModelDef.native = function (done){
    ...
    console.warn('\n'+
      '`.native()` is deprecated.  Please use `.getDatastore().sendNativeQuery()` instead.\n'+
      '(See http://sailsjs.com/upgrading)\n'
    );

    // Verify that this model is using sails-mongo as its adapter.
